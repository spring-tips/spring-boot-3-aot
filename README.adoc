...
So far, everything works well out of the box. It is our goal that the vast majority of Spring applications have a path to upgrade to Spring Boot 3 and then enjoy the benefits of native image compilation. But, soemtimes things don't work as expected. Sometimes, they don't work because one o fthe libraries on the classpath or indeed your code has done something to run afould of the cases as mentioned earlier where you'll need to furnish configuration `.json` files.
