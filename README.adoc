...
- Sometimes, they don't work because one of the libraries on the classpath or indeed your code itself has done something to run afoul of the cases as mentioned earlier where you'll need to furnish configuration `.json` files
...
- [on camera]
- once you know what configuration your application will need, it's pretty straightforward to craft the hints using the Java API. There's a pretty good way to get a lot of this work done for you: run the *java agent*.
